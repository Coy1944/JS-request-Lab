...
const repeatMyParam = () => {
    //YOUR CODE HERE
    axios.get ('http://localhost:3000/repeat/Hello-You')
    .then (function(res){
        console.log(res.data)
...
// CODE HERE
function newOne() {
    axios.get('http://localhost:3000/query-test/?text=Sam-boy')
    .then(function(res) {
        console.log(res.data)
    })
...
document.getElementById('query-button').addEventListener('click', newOne)
